...
const LoadingIndicator: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-12 bg-gray-100/50 dark:bg-gray-800/50 rounded-lg border border-gray-300 dark:border-gray-700">
      <div className="w-16 h-16 border-4 border-t-transparent border-indigo-500 rounded-full animate-spin"></div>
      <h2 className="text-2xl font-semibold mt-8 text-gray-800 dark:text-gray-200">Generating Your Video</h2>
      <p className="mt-2 text-gray-600 dark:text-gray-400 text-center transition-opacity duration-500">
